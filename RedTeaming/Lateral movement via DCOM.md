...
Among the methods used to accomplish this, the most easy and commonly used (at least in the past) wass surely PowerShell Remoting, but there are other pretty ineteresting methods used nowadays to achieve the same result. 
