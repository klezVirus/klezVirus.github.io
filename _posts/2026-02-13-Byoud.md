...
Building on the foundational insights from prior work, our current research advances the field of stack spoofing by addressing the emerging constraints introduced by Hardware-enforced Stack Protection (HSP) and Intel CET. The techniques presented, particularly the BYOUD framework, demonstrate that stack spoofing can evolve beyond basic return address manipulation and operate within CET-compliant environments.
...
This new direction revives the idea of frame obfuscation, not as an artifact of control flow hijacking, but as deliberate control flow emulation. Techniques such as frame swapping and concealed callback execution highlight the growing sophistication needed to remain stealthy in post-HSP environments.
...
has is literally the center of all current stack spoofing research.
